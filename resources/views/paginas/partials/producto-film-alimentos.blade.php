<div class="card producto">
    <div class="position-relative">  
        <a href="{{ route('productoFilmAlimentos', ['producto' => $producto->id]) }}
    ...
    <div class="card-body">
        <p class="card-text">
            <a href="{{ route('productoFilmAlimentos', ['producto' => $producto->id]) }}" class="text-decoration-none font-size-14 text-uppercase text-center d-block text-dark fw-500">{{ $producto->name }}</a>
        </p>
    </div>
</div>
